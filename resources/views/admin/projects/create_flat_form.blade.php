<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white capitalize">yeni Daire <span
                x-text="'# '+(flatIndex + 1)"></span> </h2>
        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
            <div class="w-full">
                <label for="rooms" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">oda
                    sayısı</label>
                <input type="text" :name="`flats[${flatIndex}][rooms]`" id="brand"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="1 + 1">
            </div>
            <div class="w-full">
                <label for="bathroom_count" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">banyo
                    sayısı</label>
                <input type="text" :name="`flats[${flatIndex}][bathroom_count]`" id="bathrooms_count"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="2">
            </div>
            <div class="w-full">
                <label for="net" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">net</label>
                <input type="number" :name="`flats[${flatIndex}][net]`" id="net"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="300">
            </div>
            <div class="w-full">
                <label for="gross" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">brüt</label>
                <input type="number" :name="`flats[${flatIndex}][gross]`" id="gross"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="100">
            </div>
        ...
        <template x-for="feature,index in flatFeatures">
            <div class="flex justify-evenly">
                <input placeholder="tr" type="text" :name="`flats[${flatIndex}][features][${index}][tr]`"
                ...
                <input placeholder="ru" type="text" :name="`flats[${flatIndex}][features][${index}][ru]`"
                ...
                <input placeholder="en" type="text" :name="`flats[${flatIndex}][features][${index}][en]`"
                    class="bg-gray-50 border mx-3 my-2 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="₺2999">
            </div>
        </template>
