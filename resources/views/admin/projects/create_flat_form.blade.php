    ...
    <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
        <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white capitalize">yeni Daire <span x-text="'# '+(flatIndex + 1)"></span> </h2>
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                <div class="w-full">
                    <label for="rooms"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">oda sayısı</label>
                ...
                <div class="w-full">
                    <label for="bathroom_count"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">banyo sayısı</label>
                ...
                <div class="w-full">
                    <label for="net"
                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">net</label>
             ...
             <div class="sm:col-span-2">
                @if($loop->first)
                <label for="flat_description" class="block mb-2 text-2xl font-semibold capitalize text-gray-900 dark:text-white">açıklama</label>
                @endif
