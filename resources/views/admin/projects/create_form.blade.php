        ...
        <form action="{{ route('project.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                <div class="sm:col-span-2">
                    @foreach (config('app.locales') as $locale)
                        ...
                        <input value="{{ old('title.' . $locale) }}" type="text" name="title[{{ $locale }}]"
                            id="title_tr"
                ...
                @foreach (config('app.locales') as $locale)
                    <div class="sm:col-span-2">
                        ...
                        <div id="description_{{ $locale }}" class="quill-editor bg-white text-black"></div>
            ...
            @foreach (config('app.locales') as $locale)
                <div class="sm:col-span-2 my-5">
                    ...
                    <div id="payment_plan_{{ $locale }}" class="quill-editor bg-white text-black"></div>
            ...
            @foreach (config('app.locales') as $locale)
                <div class="sm:col-span-2 my-7">
                    ...
                    <div id="extra_payment_{{ $locale }}" class="quill-editor bg-white text-black"></div>
    ...
    <script>
        ...
        locales.forEach(locale => {
            ['description', 'payment_plan', 'extra_payment'].forEach(field => {
                ...
                const oldVal = {!! json_encode(old()) !!};
                if (oldVal?.[field]?.[locale]) {
                    editors[editorId].root.innerHTML = oldVal[field][locale];
                }
            });
        });
