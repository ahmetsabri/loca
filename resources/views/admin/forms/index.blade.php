        ...
        <div class="m-5" x-data="{
                        ...
                        @foreach ($forms as $form)
                            ...
                            <tr
                                ...
                                <td scope="row"
                                    class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    @if ($form->message)
                                        <button @click="showMessage('{{ addslashes($form->message) }}')" type="button"
                                            class="px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mr-2">
                                            {{ __('Mesajı Göster') }}
                                        </button>
                                    @endif
            ...
            <div id="messageModal"
                ...
                <div class="relative p-5 border w-11/12 max-w-2xl shadow-lg rounded-md bg-white dark:bg-gray-800">
                    ...
                    <div class="mt-4">
                        <p id="messageContent" class="text-gray-900 dark:text-white whitespace-pre-wrap"></p>
                    </div>
                </div>
            </div>
        </div>
