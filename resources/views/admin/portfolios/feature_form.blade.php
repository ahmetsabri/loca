...
@for($i=0;$i<5;$i++)
    ...
    @foreach(['tr','ru','en'] as $locale)
     <div class="mb-5 mx-1">
      ...
      <input name="features[{{$i}}][{{$info->id}}][{{$locale}}]" type="text" id="base-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
  </div>
