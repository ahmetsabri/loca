...
@endphp
 ...
 @foreach($featureValues as $i=>$featureValue)
 <div class="flex">
    ...
    <div class="mb-5 mx-1">
        ...
        <input value="{{ $featureValue->getTranslation('value',$locale) }}" name="features[{{$i}}][{{$feature->id}}][{{$locale}}]" type="text" id="base-input"
    ...
    <div class="mb-5 mx-1">
        ...
        <input :name="`features[${index+100}][{{$feature->id}}][tr]`" type="text" id="base-input"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    </div>
    ...
    <div class="mb-5 mx-1 w-1/3">
            ...
            <input :name="`features[${index+100}][{{$feature->id}}][ru]`" type="text" id="base-input"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
        ...
        <div class="mb-5 mx-1 w-1/3">
                ...
                <input :name="`features[${index+100}][{{$feature->id}}][en]`" type="text" id="base-input"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            </div>
            </div>
</template>
