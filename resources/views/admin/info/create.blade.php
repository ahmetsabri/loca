...
<div class="p-4">
                ...
                <form class="space-y-4 flex flex-wrap justify-center" action="{{route('info.store')}}" method="post">
                    @csrf
    ...
    <ul>
        ...
        <li>
            ...
            :class="{'bg-slate-400 text-white': selected1stCategory == child.id}"
                class="font-bold capitalize text-gray-600 dark:text-gray-500 hover:underline" x-text="child.name.tr">
            </a>
        </li>
        </template>
    </ul>
...
<div class="flex bg-slate-200 p-5 justify-center" x-show="secondLevelChildren.length">
    <ul>
        ...
        <li>
            <a href="#"
            @click="selected2ndCategory = child.id"
            :class="{'bg-slate-400 text-white': selected2ndCategory == child.id}"
                class="font-bold capitalize text-gray-600 dark:text-gray-500 hover:underline" x-text="child.name.tr">
                    ...
                    <div class="w-1/3 mx-auto">
                        <label for="infos" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white uppercase">{{ $locale
                            }}</label>
