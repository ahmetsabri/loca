                    ...
                    <div
                        ...
                        {{ $portfolio->price }}
                                ...
                                <button @click="addToFavorites(`{{ $portfolio->id }}`)"
                                    class="button shrink-0 add-favorite group/button relative duration-300 bg-[#EFF5FF] flex items-center justify-center h-10 aspect-square rounded-full hover:border-tertiary-950/30" :class="localStorage.getItem(`portfolio_{{ $portfolio->id }}`) && 'favorited'" >
                                    <div
