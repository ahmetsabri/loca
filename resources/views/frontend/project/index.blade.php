...
@endforeach
                    ...
                    <div
                        class="pagination flex items-center justify-center gap-2.5 flex-wrap mt-17 2xl:mt-15 xl:mt-13 lg:mt-11 md:mt-9">
                        ...
                        <a href="javascript:void(0)"
                            class="flex duration-300 items-center justify-center w-6.5 aspect-square shrink-0 rounded-1.5 border border-solid border-[#8AA5D3]/35 text-3.5 font-medium text-tertiary-950 hover:border-[#2675FA] [&.current]:pointer-events-none [&.current]:bg-[#2675FA] [&.current]:border-[#2675FA] [&.current]:text-white current">1</a>
                        <a href="javascript:void(0)"
                            class="flex duration-300 items-center justify-center w-6.5 aspect-square shrink-0 rounded-1.5 border border-solid border-[#8AA5D3]/35 text-3.5 font-medium text-tertiary-950 hover:border-[#2675FA] [&.current]:pointer-events-none [&.current]:bg-[#2675FA] [&.current]:border-[#2675FA] [&.current]:text-white">2</a>
                        <a href="javascript:void(0)"
                            class="flex duration-300 items-center justify-center w-6.5 aspect-square shrink-0 rounded-1.5 border border-solid border-[#8AA5D3]/35 text-3.5 font-medium text-tertiary-950 hover:border-[#2675FA] [&.current]:pointer-events-none [&.current]:bg-[#2675FA] [&.current]:border-[#2675FA] [&.current]:text-white">3</a>
                        <a href="javascript:void(0)"
                            class="flex duration-300 items-center justify-center w-6.5 aspect-square shrink-0 rounded-1.5 border border-solid border-[#8AA5D3]/35 text-3.5 font-medium text-tertiary-950 hover:border-[#2675FA] [&.current]:pointer-events-none [&.current]:bg-[#2675FA] [&.current]:border-[#2675FA] [&.current]:text-white">4</a>
                        <a href="javascript:void(0)"
                            class="flex duration-300 items-center justify-center w-6.5 aspect-square shrink-0 rounded-1.5 border border-solid border-[#8AA5D3]/35 text-3.5 font-medium text-tertiary-950 hover:border-[#2675FA] [&.current]:pointer-events-none [&.current]:bg-[#2675FA] [&.current]:border-[#2675FA] [&.current]:text-white">5</a>
                        <a href="javascript:void(0)"
                            class="flex duration-300 items-center justify-center w-6.5 aspect-square shrink-0 rounded-1.5 border border-solid border-[#2675FA] text-3.5 font-medium text-tertiary-950 hover:bg-[#2675FA] hover:text-white">
