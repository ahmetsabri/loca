        ...
        <div
            ...
            <div class="naming">
                ...
                <div class="adress flex items-center gap-1">
                    ...
                    <div class="text text-4 text-[#6D6D6D] font-medium leading-tight">{{ $project->full_address }}</div>
                </div>
            </div>
        </div>
        <div
            class="share-wrapper flex-wrap p-11 2xl:p-10 xl:p-8 lg:p-6 flex items-center justify-evenly gap-7.5 sm:gap-4">
            <a target="_blank" href="{{  $project->share_links['wp'] }}" class="item block group">
            ...
            <a target="_blank" href="{{  $project->share_links['fb'] }} " class="item block group">
                <img class="w-7.5 aspect-square object-contain object-center block mx-auto"
            ...
            <a target="_blank" href="{{  $project->share_links['x']  }}" class="item block group">
                <img class="w-7.5 aspect-square object-contain object-center block mx-auto"
            ...
            <a href="{{ $project->share_links['email'] }} " class="item block group">
                <img class="w-7.5 aspect-square object-contain object-center block mx-auto"
            ...
            <a href="{{ $project->share_links['sms']  }}" class="item block group">
                <img class="w-7.5 aspect-square object-contain object-center block mx-auto"
        ...
        <div class="copy-wrapper px-11 2xl:px-10 xl:px-8 lg:px-6 pb-11 2xl:pb-10 xl:pb-8 lg:pb-6 pt-6 bg-[#F2F8FD]">
            ...
            <div
                ...
                <div class="link w-[calc(100%-72px)] text-3.5 font-medium text-tertiary-950"><span
                        class="line-clamp-1">{{ route('frontend.project.show',$project) }}</span></div>
                <button
