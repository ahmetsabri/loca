                ...
                <div
                    ...
                    <div class="carousel-wrapper w-full">
                        <div
                            ...
                            <div class="swiper-wrapper !h-auto">
                                <div class="swiper-slide">
                                    <a href="portfolio-detail.html"
                                        class="image group block aspect-[36/25] overflow-hidden isolate translate-z-0"><img
                                            ...
                                            src="{{ asset('image/other/2.webp') }}" alt="" loading="lazy"></a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="portfolio-detail.html"
                                        class="image group block aspect-[36/25] overflow-hidden isolate translate-z-0"><img
                                ...
                                <div class="swiper-slide">
                                    <a href="portfolio-detail.html"
                                        class="image group block aspect-[36/25] overflow-hidden isolate translate-z-0"><img
                                            class="full-cover group-hover:scale-105 duration-450 translate-z-0 pointer-events-none"
                                            src="{{ asset('image/other/3.webp') }}" alt="" loading="lazy"></a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="portfolio-detail.html"
                                        class="image group block aspect-[36/25] overflow-hidden isolate translate-z-0"><img
                            ...
                            <div
                                class="tag absolute left-4 top-4 bg-tertiary-950/50 rounded-2 px-2 py-1.5 text-white text-3 font-medium leading-none z-5">
                                ARSA</div>
                        </div>
                    </div>
                    <div class="content-wrapper p-5 lg:p-4 mt-2.5">
                        <div class="item flex items-center gap-2 mb-2">
                            ...
                            <div class="text text-3.5 font-medium text-tertiary-950/40">Mersin/Merkez, Deniz Mah
                            </div>
                        </div>
                        <a href="portfolio-detail.html"
                            class="title text-4.5 leading-tight text-tertiary-950 hover:text-main-700 duration-300 font-semibold mb-4 xl:mb-5 md:mb-4 block">Fırsat
                            İmarlı Arsa</a>
                        <div class="price text-[#2675FA] font-semibold text-5 lg:text-4.5 md:text-4">1.250,000
                            TL</div>
                            ...
                            <div class="swiper-wrapper !h-auto">
                                <div class="swiper-slide">
                                    <a href="portfolio-detail.html"
                                        class="image group block aspect-[36/25] overflow-hidden isolate translate-z-0"><img
                                            class="full-cover group-hover:scale-105 duration-450 translate-z-0 pointer-events-none"
                                            src="{{ asset('image/photo/12.webp') }}" alt="" loading="lazy"></a>
                                </div>
                                <div class="swiper-slide">
                                    <a href="portfolio-detail.html"
                                        class="image group block aspect-[36/25] overflow-hidden isolate translate-z-0"><img
